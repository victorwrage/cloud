...
public class CustomDatePicker {
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            ...
            datePickerDialog.setContentView(R.layout.pop_picker);
    ...
    private void initView() {
        ...
        Drawable drawable = context.getResources().getDrawable(R.drawable.cancel);
        drawable.setBounds(0, 2, 20, 20);
        tv_cancle.setCompoundDrawables(null, drawable, null, null);

        Drawable drawable4 = context.getResources().getDrawable(R.drawable.confirm_ok);
        drawable4.setBounds(0, 2, 20, 20);
        tv_select.setCompoundDrawables(null, drawable4, null, null);
